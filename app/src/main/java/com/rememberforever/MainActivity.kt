...
import com.rememberforever.core.data.db.dao.CategoryTotal
import com.rememberforever.core.data.db.dao.MonthTotal
...
import com.rememberforever.core.data.db.entity.LedgerType
...
import com.rememberforever.core.data.db.entity.toAmountCents
import com.rememberforever.core.data.db.entity.toYuanText
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val container = (application as RememberForeverApp).container
        setContent {
            RememberForeverTheme {
                RememberForeverApp(container)
            }
        }
    }
}
...
@Composable
private fun RememberForeverApp(container: AppContainer) {
...
private fun HomeScreen(container: AppContainer, navController: NavHostController) {
    ...
    LazyColumn(
        ...
        item {
            Text("Remember Forever", style = MaterialTheme.typography.headlineMedium, fontWeight = FontWeight.Bold)
        }
        item {
            BudgetSummaryCard(
                budgetState = budget,
...
private fun BudgetSummaryCard(
    budgetState: com.rememberforever.core.data.repository.BudgetState?,
    onClick: () -> Unit
) {
...
private fun BudgetEditor(
    current: com.rememberforever.core.data.repository.BudgetState?,
    budgetText: String,
    warningRatio: Float,
...
private fun WorkdayOverrideEditor(
    dateText: String,
    overrides: List<com.rememberforever.core.data.db.entity.WorkdayOverrideEntity>,
    onDate: (String) -> Unit,
    onSetWorkday: () -> Unit,
    onSetHoliday: () -> Unit,
    onClear: () -> Unit
...
@Composable
private fun RememberForeverTheme(content: @Composable () -> Unit) {
    MaterialTheme(
